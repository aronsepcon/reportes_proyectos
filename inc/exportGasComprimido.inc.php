...
$objPHPExcel->setActiveSheetIndex()->setCellValue('E8', 'Lugar de la actividad');
$objPHPExcel->setActiveSheetIndex()->setCellValue('F8', 'Empresa');
$objPHPExcel->setActiveSheetIndex()->setCellValue('G8', 'Elaborado por');
$objPHPExcel->setActiveSheetIndex()->setCellValue('H8', "Responsable del taller");
...
$objPHPExcel->setActiveSheetIndex()->setCellValue('L8', "Respuesta");
$objPHPExcel->setActiveSheetIndex()->setCellValue('M8', "Observaciones");
...
if ($rowaffect > 0) {
    foreach ($results as $rs) {
        ...
        $objPHPExcel->setActiveSheetIndex()->setCellValue('E' . $fila, $rs['lugar']);
        ...
        $objPHPExcel->setActiveSheetIndex()->setCellValue('L' . $fila, valorRespuesta($rs['respuesta']));
...
$objWriter->save('../reports/gasComprimido.xlsx');
exit();
