...
$objPHPExcel->getProperties()->setTitle("Reporte Inspección botiquin"); // Titulo
...
$objPHPExcel->setActiveSheetIndex()->setCellValue('D2', 'Reporte de Inspección de botiquin');
...
$objWriter->save('../reports/inspeccionBotiquin.xlsx');
exit();
