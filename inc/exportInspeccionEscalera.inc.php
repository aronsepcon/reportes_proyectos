...
$objPHPExcel->getProperties()->setTitle("Reporte Inspección escaleras fijas y portátiles"); // Titulo
...
$objPHPExcel->setActiveSheetIndex()->setCellValue('D2', 'Reporte de Inspección de escaleras fijas y portátiles ');
...
$objPHPExcel->setActiveSheetIndex()->setCellValue('E8', 'Supervisor');
$objPHPExcel->setActiveSheetIndex()->setCellValue('F8', "Empresa");
...
$objPHPExcel->setActiveSheetIndex()->setCellValue('J8', "Código");
$objPHPExcel->setActiveSheetIndex()->setCellValue('K8', "Tipo");
$objPHPExcel->setActiveSheetIndex()->setCellValue('L8', "Condición");
$objPHPExcel->setActiveSheetIndex()->setCellValue('M8', "Comentarios");
...
if ($rowaffect > 0) {
    foreach ($results as $rs) {
        ...
        $objPHPExcel->setActiveSheetIndex()->setCellValue('E' . $fila, $rs['supervisor']);
        $objPHPExcel->setActiveSheetIndex()->setCellValue('F' . $fila, $rs['empresa']);
        $objPHPExcel->setActiveSheetIndex()->setCellValue('G' . $fila, $rs['inspeccionado']);
        ...
        $objPHPExcel->setActiveSheetIndex()->setCellValue('J' . $fila, $rs['codigo']);
        $objPHPExcel->setActiveSheetIndex()->setCellValue('K' . $fila, $rs['tipo_escalera']);
        $objPHPExcel->setActiveSheetIndex()->setCellValue('L' . $fila, $rs['condicion']);
        $objPHPExcel->setActiveSheetIndex()->setCellValue('M' . $fila, $rs['comentario']);
...
$objWriter->save('../reports/inspeccionEscalera.xlsx');
exit();
