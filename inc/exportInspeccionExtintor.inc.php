...
$objPHPExcel->getProperties()->setTitle("Reporte Inspección de extintores"); // Titulo
...
$objPHPExcel->setActiveSheetIndex()->setCellValue('D2', 'Reporte de Inspección de extintores');
...
$objPHPExcel->setActiveSheetIndex()->setCellValue('K8', "Condición");
$objPHPExcel->setActiveSheetIndex()->setCellValue('L8', "Clasificación");
$objPHPExcel->setActiveSheetIndex()->setCellValue('M8', "Acción correctiva");
$objPHPExcel->setActiveSheetIndex()->setCellValue('N8', "Responsable de la acción");
$objPHPExcel->setActiveSheetIndex()->setCellValue('O8', "Fecha de cumplimiento");
$objPHPExcel->setActiveSheetIndex()->setCellValue('P8', "Seguimiento");
$objPHPExcel->setActiveSheetIndex()->setCellValue('Q8', "Evidencia");
...
if ($rowaffect > 0) {
    foreach ($results as $rs) {
        ...
        $objPHPExcel->setActiveSheetIndex()->setCellValue('K' . $fila, $rs['condicion']);
        $objPHPExcel->setActiveSheetIndex()->setCellValue('L' . $fila, valorCalificacion($rs['clasificacion']));
        $objPHPExcel->setActiveSheetIndex()->setCellValue('M' . $fila, $rs['accion_correctiva']);
        $objPHPExcel->setActiveSheetIndex()->setCellValue('N' . $fila, $rs['usuario_responsable_detalle']);
        $objPHPExcel->setActiveSheetIndex()->setCellValue('O' . $fila, $rs['fecha_cumplimiento']);
        $objPHPExcel->setActiveSheetIndex()->setCellValue('P' . $fila, $rs['seguimiento']);
...
$objWriter->save('../reports/inspeccionExtintor.xlsx');
exit();
