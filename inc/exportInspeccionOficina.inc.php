...
$objPHPExcel->setActiveSheetIndex()->setCellValue('J8', "Pregunta");
...
if ($rowaffect > 0) {
    foreach ($results as $rs) {
        ...
        $objPHPExcel->setActiveSheetIndex()->setCellValue('J' . $fila, $rs['pregunta']);
...
$objWriter->save('../reports/inspeccionOficina.xlsx');
exit();
