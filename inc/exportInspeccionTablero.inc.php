...
$objPHPExcel->getProperties()->setTitle("Reporte Inspección mensual de tableros electricos"); // Titulo
...
$objPHPExcel->setActiveSheetIndex()->setCellValue('D2', 'Reporte de Inspección mensual de tableros electricos');
...
$objPHPExcel->setActiveSheetIndex()->setCellValue('F8', 'Código TAG');
$objPHPExcel->setActiveSheetIndex()->setCellValue('G8', "Aprobado");
$objPHPExcel->setActiveSheetIndex()->setCellValue('H8', "Elaborado por");
$objPHPExcel->setActiveSheetIndex()->setCellValue('I8', "Descripción");
$objPHPExcel->setActiveSheetIndex()->setCellValue('J8', "Responsable");
$objPHPExcel->setActiveSheetIndex()->setCellValue('K8', "Fecha");
$objPHPExcel->setActiveSheetIndex()->setCellValue('L8', "Registro");
$objPHPExcel->setActiveSheetIndex()->setCellValue('M8', "Elemento");
$objPHPExcel->setActiveSheetIndex()->setCellValue('N8', "Aplica");
$objPHPExcel->setActiveSheetIndex()->setCellValue('O8', "Cumple");
...
if ($rowaffect > 0) {
    foreach ($results as $rs) {
        ...
        $objPHPExcel->setActiveSheetIndex()->setCellValue('F' . $fila, $rs['codigo_tag']);
        $objPHPExcel->setActiveSheetIndex()->setCellValue('G' . $fila, $rs['aprobado']);
        ...
        $objPHPExcel->setActiveSheetIndex()->setCellValue('J' . $fila, strtoupper($rs['usuario_responsable']));
        $objPHPExcel->setActiveSheetIndex()->setCellValue('K' . $fila, date("d/m/Y", strtotime($rs['fecha'])));
        $objPHPExcel->setActiveSheetIndex()->setCellValue('L' . $fila, date("d/m/Y", strtotime($rs['registro'])));
        $objPHPExcel->setActiveSheetIndex()->setCellValue('M' . $fila, $rs['elemento']);
        $objPHPExcel->setActiveSheetIndex()->setCellValue('N' . $fila, valorRespuestaTable($rs['aplica']));
        $objPHPExcel->setActiveSheetIndex()->setCellValue('O' . $fila, valorRespuestaTable($rs['cumple']));
...
$objWriter->save('../reports/inspeccionTablero.xlsx');
exit();
