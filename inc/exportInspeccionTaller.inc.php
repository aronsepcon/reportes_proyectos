...
$objPHPExcel->getProperties()->setTitle("Reporte Inspección de talleres"); // Titulo
...
$objPHPExcel->setActiveSheetIndex()->setCellValue('D2', 'Reporte de Inspección de talleres');
...
$objPHPExcel->setActiveSheetIndex()->setCellValue('K8', "Calificación");
$objPHPExcel->setActiveSheetIndex()->setCellValue('L8', "Observaciones");
...
if ($rowaffect > 0) {
    foreach ($results as $rs) {
        ...
        $objPHPExcel->setActiveSheetIndex()->setCellValue('K' . $fila, $rs['calificacion']);
        $objPHPExcel->setActiveSheetIndex()->setCellValue('L' . $fila, $rs['observacion']);
...
$objWriter->save('../reports/inspeccionTaller.xlsx');
exit();
