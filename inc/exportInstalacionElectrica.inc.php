...
$objPHPExcel->getProperties()->setTitle("Reporte Instalaciones electricas temporales"); // Titulo
...
$objPHPExcel->setActiveSheetIndex()->setCellValue('D2', 'Reporte de Instalaciones electricas temporales');
...
$objPHPExcel->setActiveSheetIndex()->setCellValue('E8', 'Obra / Fase');
$objPHPExcel->setActiveSheetIndex()->setCellValue('F8', 'Campamento');
$objPHPExcel->setActiveSheetIndex()->setCellValue('G8', "Elaborado por");
$objPHPExcel->setActiveSheetIndex()->setCellValue('H8', "Responsable");
$objPHPExcel->setActiveSheetIndex()->setCellValue('I8', "Fecha");
$objPHPExcel->setActiveSheetIndex()->setCellValue('J8', "Registro");
$objPHPExcel->setActiveSheetIndex()->setCellValue('K8', "Elemento");
$objPHPExcel->setActiveSheetIndex()->setCellValue('L8', "Estado");
...
if ($rowaffect > 0) {
    foreach ($results as $rs) {
        ...
        $objPHPExcel->setActiveSheetIndex()->setCellValue('E' . $fila, $rs['obra_fase']);
        $objPHPExcel->setActiveSheetIndex()->setCellValue('F' . $fila, $rs['campamento']);
        ...
        $objPHPExcel->setActiveSheetIndex()->setCellValue('I' . $fila, date("d/m/Y", strtotime($rs['fecha'])));
        $objPHPExcel->setActiveSheetIndex()->setCellValue('J' . $fila, date("d/m/Y", strtotime($rs['registro'])));
        $objPHPExcel->setActiveSheetIndex()->setCellValue('K' . $fila, $rs['elemento']);
        $objPHPExcel->setActiveSheetIndex()->setCellValue('L' . $fila, $rs['estado']);
...
$objWriter->save('../reports/instalacionElectrica.xlsx');
exit();
