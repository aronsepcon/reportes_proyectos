$(function() {
    ...
    $("#btnBefore").on("click", function(event) {
        ...
        SEDE = $("#sede").val();
        $.post("../inc/tablesBefore.inc.php", { doc: 'inspeccionTaller', me: $("#mes").val(), an: $("#anio").val() ,sede :SEDE },
    ...
    function downloadEncabezadoTopsNuevo(event) {
        ...
        $.post("../inc/exportInspeccionTaller.inc.php", {"sede" : SEDE ,"fecha_inicio" :FECHA_INICIO , "fecha_fin" :FECHA_FIN},
            function (data, textStatus, jqXHR) {
            ...
            var url = "../reports/inspeccionTaller.xlsx";
            event.preventDefault();
