$(function() {
    ...
    $("#btnBefore").on("click", function(event) {
        ...
        SEDE = $("#sede").val();
        $.post("../inc/tablesBefore.inc.php", { doc: 'productoQuimico', me: $("#mes").val(), an: $("#anio").val() ,sede :SEDE },
    ...
    function downloadEncabezadoTopsNuevo(event) {
        ...
        $.post("../inc/exportproductoQuimico.inc.php", {"sede" : SEDE ,"fecha_inicio" :FECHA_INICIO , "fecha_fin" :FECHA_FIN},
            function (data, textStatus, jqXHR) {
            ...
            var url = "../reports/productoQuimico.xlsx";
            event.preventDefault();
