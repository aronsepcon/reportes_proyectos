...
$sede = $_GET['sede'];
$row = getReporteGasComprimido($pdo, $sede);
...
<head>
    ...
    <title>Reporte de Check list</title>
</head>
...
<body>
    ...
    <div class="wrap">
        <div class="headerWrap">
            <h3>CHECK LIST ALMACENAMIENTO DE GASES COMPRIMIDOS- <?php echo $_GET['nombre'] ?> </h3>
        </div>
        <div class="divsearch">
            <div class="search">
            ...
            <table id="tablaReporte">
                <thead>
                    <tr>
                        ...
                        <th width="200px">Lugar de la actividad</th>
