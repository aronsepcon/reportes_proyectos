...
$sede = $_GET['sede'];
$row = getReporteInspeccionBotiquin($pdo, $sede);
...
<head>
    ...
    <script src="../js/inspeccionBotiquin.js?<?php echo constant("VERSION") ?>"></script>

    <title>Reporte de Inspeccion botiquin </title>
</head>
