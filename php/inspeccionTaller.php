...
$sede = $_GET['sede'];
$row = getReporteInspeccionTaller($pdo, $sede);
...
<head>
    ...
    <script src="../js/inspeccionTaller.js?<?php echo constant("VERSION") ?>"></script>
...
<body>
    ...
    <div class="wrap">
        <div class="headerWrap">
            <h3>Inspección de talleres- <?php echo $_GET['nombre'] ?> </h3>
        </div>
        <div class="divsearch">
            <div class="search">
            ...
            <table id="tablaReporte">
                <thead>
                    <tr>
                        ...
                        <th width="20px">Lugar de la actividad</th>
