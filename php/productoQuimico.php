...
$sede = $_GET['sede'];
$row = getReporteProductoQuimico($pdo, $sede);
...
<head>
    ...
    <script src="../js/gasComprimido.js?<?php echo constant("VERSION") ?>"></script>

    <title>Reporte Inspección almacén de productos químicos</title>
</head>
...
<body>
    ...
    <div class="wrap">
        <div class="headerWrap">
            <h3>Inspección almacén de productos químicos - <?php echo $_GET['nombre'] ?> </h3>
        </div>
        <div class="divsearch">
            <div class="search">
            ...
            <table id="tablaReporte">
                <thead>
                    <tr>
                        ...
                        <th width="250px">Responsable del taller</th>
                        <th width="20px">Fecha</th>
                        <th width="20px">Registro</th>
                        <th width="200px">Elemento</th>
                        <th width="200px">Almacén de productos químicos</th>
                        <th width="200px">Pit de hidrocarburos</th>
